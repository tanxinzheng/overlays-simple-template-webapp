...
import com.xmomen.framework.exception.PaginationException;
...
public class PageInterceptor implements Interceptor {
    ...
    public static void startPage(BaseQuery baseQuery) {
        startPage(baseQuery.getPageNum(), baseQuery.getPageSize(), true);
    }
    ...
    public static void startPage(int pageNum, int pageSize, boolean count) {
        if(pageNum == 0 || pageSize == 0){
            throw new PaginationException(PaginationException.NOT_PAGINATION_PARAMETER);
        }
