...
import com.xmomen.module.permission.model.CreateUserGroup;
import com.xmomen.module.permission.model.GroupPermissionRelation;
import com.xmomen.module.permission.model.UpdateUserGroup;
...
public class UserGroupController {
    ...
    public Page<SysRoles> getGroupList(@RequestParam(value = "limit") Integer limit,
    ...
    public void findUsersByGroup(@PathVariable(value = "groupId") Integer groupId,
        ...
        if(chose != null && chose){
            roleService.correlationRoles(userId, groupId);
        }else{
            roleService.uncorrelationRoles(userId, groupId);
        }
    }
