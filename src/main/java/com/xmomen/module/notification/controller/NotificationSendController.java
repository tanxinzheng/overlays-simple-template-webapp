...
public class NotificationSendController extends BaseRestController {
    ...
    public NotificationSendModel createNotificationSend(@RequestBody @Valid NotificationSendModel notificationSendModel) {
        notificationSendModel.setSender(getCurrentUserId());
        return notificationSendService.createNotificationSend(notificationSendModel);
    }
