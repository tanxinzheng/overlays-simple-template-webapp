...
public class NotificationController extends BaseRestController {
    ...
    public NotificationModel createNotification(@RequestBody @Valid NotificationModel notificationModel) {
        return notificationService.createNotification(notificationModel);
    }
