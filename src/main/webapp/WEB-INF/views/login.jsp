...
<head>
    ...
    <!-- Angular Related CSS -->
    <link rel="stylesheet" type="text/css" media="screen" href="./static/css/ng.min.css">
    ...
    <link rel="apple-touch-icon" href="./static/images/splash/sptouch-icon-iphone.png">
    <link rel="apple-touch-icon" sizes="76x76" href="./static/images/splash/touch-icon-ipad.png">
    <link rel="apple-touch-icon" sizes="120x120" href="./static/images/splash/touch-icon-iphone-retina.png">
    <link rel="apple-touch-icon" sizes="152x152" href="./static/images/splash/touch-icon-ipad-retina.png">
    ...
    <link rel="apple-touch-startup-image" href="./static/images/splash/ipad-landscape.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
    <link rel="apple-touch-startup-image" href="./static/images/splash/ipad-portrait.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:portrait)">
    <link rel="apple-touch-startup-image" href="./static/images/splash/iphone.png" media="screen and (max-device-width: 320px)">
...
<header id="header">
    ...
    <div id="logo-group">
        <span id="logo"> <images src="./static/images/logo.png" alt="订单管理系统"> </span>
