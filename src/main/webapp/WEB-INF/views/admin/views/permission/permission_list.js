...
define(function () {
    return ["$scope", "PermissionAPI", "$modal", "$ugDialog", function($scope, PermissionAPI, $modal, $ugDialog){
        ...
        $scope.openPermission = function (index, size) {
            var permission = $scope.permissionList[index];
            var modalInstance = $modal.open({
                ...
                controller: ["$scope", "PermissionAPI", "CurrentPermission", "$modalInstance", function ($scope, PermissionAPI, CurrentPermission, $modalInstance) {
                    $scope.permission = {};
                    ...
                    $scope.savePermission = function(){
                        ...
                        if($scope.addPermissionForm.validator.form()){
                            ...
                            if($scope.permission.id){
                                PermissionAPI.update($scope.permission, function(){
                                    $modalInstance.close();
                                }, function(data){
